...
export default () => ({
  ...
  updateCategory: (organization, id, payload) => axios.patch(`${organization}/categories/${id}`, payload),
  ...
  updateItem: (organization, id, payload) => axios.patch(`${organization}/items/${id}`, payload),
